      ...
      <div className="portfolio-content">
        ...
        <div className="col">
            ...
            <a href="https://docs.google.com/document/d/1BSP30bwGhRQ4jp_2Q4IT_XzKoD5q-iRPJ9UoeIqqqRM/edit" alt="Loading..."> <img src={FPGAPic} alt=""/> </a>
                ...
                <h3>FPGA Design <h4></h4> </h3>
      
            <h5>Used an FPGA to create an entertaining game coded in verilog using Vivado</h5>
        </div>

        <div className="col">
            <a href="https://github.com/KishorKumar11/RTOS" alt=""> <img src={KuramaPic} alt="Loading..."/> </a>
        ...
        <div class="col">
            <a href="https://www.figma.com/file/lGEQ2NaUq4o9Um7a1xbISz/CS3240-Group-13-Mall-In-One-team-library?node-id=0%3A1" alt="Loading..."> <img src={MIOPic} alt="Coming soon" /> </a>
                ...
                <h3>Mall in One <h4></h4> </h3>
      
            <h5>An UI/UX project-based web application built using Figma and Balsamiq that allows shoppers to plan ahead before visiting shopping malls by being able to access information such as item availability and address</h5>
        </div>
